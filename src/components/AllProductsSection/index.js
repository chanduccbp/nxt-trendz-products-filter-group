...
class AllProductsSection extends Component {
  ...
  updateSearch = inpvalue => {
    this.setState({titleSearch: inpvalue})
  }
  ...
  renderProductsList = () => {
    ...
    const renderNoProductsView = productsList.length === 0
    return (
  ...
  render() {
    ...
    const showProductsOrError = showFailureView
    ...
    return (
      <div className="all-products-section">
        ...
        {isLoading ? this.renderLoader() : showProductsOrError}
      </div>
    )
  }
}
